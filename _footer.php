    ...
    <div class="container d-flex p-2">
        <div class="mx-auto d-flex flex-column justify-content-center align-content-around">
            <ul class="d-flex justify-content-evenly" style="list-style: none; padding-left: 0;">
                ...
                <li><a href="https://www.instagram.com/kjsit_official/" target="_blank"><img src="/syss/assets/images/icon_insta.png" alt="" style="max-width: 30px;"></a></li>
            ...
            <div>
                <p class="fw-light text-center my-0">Department of Computer Engineering</p>
                <p class="fw-light text-center my-0">2021-22</p>
            </div>
            <p class="text-center text-dark" style="font-size: medium"><a href="tel:91-22-24061408">91-22-24061408</a> / <a href="tel:912224061403">91-22-24061403</a> / <a href="mailto:info.tech@somaiya.edu">info.tech@somaiya.edu</a></p>
        </div>
    </div>
